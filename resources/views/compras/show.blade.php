...
<div class="container">
    <div class="d-flex justify-content-between mb-3">
        <h1 class="h3">{{ $title }} #{{ $compra->compra_id }}</h1>
    ...
    <div class="row g-3 mb-3">
        <div class="col-md-4">
            <div class="card"><div class="card-body">
                ...
                <div>{{ \Carbon\Carbon::parse($compra->fecha_compra)->format('Y-m-d') }}</div>
            </div></div>
        </div>
        <div class="col-md-4">
            <div class="card"><div class="card-body">
                <div class="fw-bold">Proveedor</div>
                <div>{{ optional($compra->proveedor)->nombre }}</div>
            </div></div>
        </div>
        <div class="col-md-4">
            <div class="card"><div class="card-body">
                <div class="fw-bold">Empleado</div>
                <div>{{ optional($compra->empleado)->nombre }}</div>
            </div></div>
        </div>
    </div>
    ...
    <div class="table-responsive">
        <table class="table table-striped align-middle">
            ...
            <tbody>
            @foreach($compra->detalleCompras as $d)
                <tr>
